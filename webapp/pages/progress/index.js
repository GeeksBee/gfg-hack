      ...
      <main>
        <div className="flex items-center flex-col">
          ...
          {!addProductModalOpen ? (
                ...
                <div className="w-full">
                  {Array(4)
                    ...
                    .map((e, i) => (
                      <div
                        key={i}
                        className="w-full text-sm rounded-xl flex flex-col sm:flex-row p-6 mb-4 last:mb-0 shadow-4xl border-[#f0f0f0] 303131]"
                      >
            ...
            <></>
            // <AddProductModal setShowModal={setAddProductModalOpen} />
          )}
        </div>
      </main>
    </div>
